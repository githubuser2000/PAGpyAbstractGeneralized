...
LOCAL_NOTE_TEXTS = {'contribution time directed by truth-vector priority, not wage/price': 'el tiempo de contribución se dirige por prioridad del vector de verdad, no por '
                                                                        'salario ni precio',
 'surplus and deficit matched by urgency, not purchasing power': 'excedente y déficit se emparejan por urgencia, no por poder adquisitivo',
...
def art_buy_sell_replacement() -> None:
    ...
    rows = [
        ...
        ("IMPORTACIÓNACIÓN", "transferir efecto desde fuera hacia escasez", "planetary_transfer", (0, 229, 255)),
        ("EXPORTACIÓNACIÓN", "dar excedente a diferencia real", "planetary_transfer", (38, 222, 129)),
    ]
