...
Nach einem Lauf entstehen im Ausgabeordner. Zusätzlich zeigt die Simulation am Ende standardmäßig eine lange bunte UTF8-Art-Auswertung direkt in der Konsole:
...
## Neue farbige UTF8-Art-Auswertung

Seit Version 1.2.0 erzeugt die Simulation eine große visuelle Text-Auswertung mit vielen Abschnitten. Zu jedem Abschnitt gibt es immer:
...
Wenn du die große bunte Ausgabe nur als Datei möchtest, kannst du `utf8_dashboard.md` oder `utf8_dashboard_ansi.txt` im Ausgabeverzeichnis öffnen. Mit `--quiet` wird die Konsole leiser, die Dateien werden aber weiterhin geschrieben.
