...
V4 ergänzt keine neue ökonomische Phase, sondern macht die vorhandene UTF‑8/ANSI-Ausgabe robust für echte Terminals:

- automatische Erkennung der Terminalspalten
- Sicherheitsabzug von 5 Zeichen
- `--art-width 0` als Auto-Modus
- explizite `--art-width`-Werte werden auf `Terminalbreite - 5` gedeckelt
- ANSI-Farben werden bei der Breitenmessung ignoriert
- breite UTF‑8-Zeichen werden konservativ gezählt
- Boxrahmen bleiben innerhalb der sicheren Breite
- Boxinhalte, Tabellen, Ereignisbeschreibungen und lange Diagrammzeilen werden innerhalb der Rahmen umgebrochen
- zusätzlicher finaler Schutzumbruch verhindert Fehldarstellung auch bei später ergänzten Renderern

# V5 Ergänzungen

V5 verändert die ökonomischen Kernmechaniken nicht aggressiv, sondern macht deutlich mehr davon direkt im Terminal sichtbar. Neu abgedeckt in der Ausgabe:

- Geldmassen-River nach Akteursklasse
- Vektor-Bilanz der Akteursklassen, zerlegt in Gut/Böse- und Beliebt/Unbeliebt-Komponente
- 360° Winkel-Liquiditätsrad für Cashwinkel, Kaufwinkel, Verkaufswinkel und K/V-Gap
- konkrete Order-Ausführungsleiter zwischen Käufer-Kaufwinkel und Verkäufer-Verkaufswinkel
- Kauf-/Verkaufswinkel-Spread-Histogramm
- Dreiecksbörsen-Diagramm `Wert ↔ Gutartigkeit ↔ Beliebtheit`
- Finanzsystem-Karte für Kredit, Bonds, Aktien, Hypotheken, Versicherung und FX
- Orakel-Divergenz je Land zwischen Regierung/Gerichten, Volk/Medien und Währungswinkel
- Verfassungs-/Gerichtsschutz-Dashboard gegen Winkelmissbrauch
- Sektor-Heatmap für Wertgewicht, Gutartigkeit, Beliebtheit, Konfidenz und Winkel
- Sektorökonomie mit Arbeit, Preisen, Löhnen, Profit und Technologie
- Lieferketten-Matrix mit Inputsektoren, Umweltlast und Sozialnutzen
- Konzern-/Holding-Netzwerk mit Opazität, Tax Havens, Transfer Pricing und Steuervermeidung
- Medien-/Beliebtheitsmacht-Karte
- Ratingmarkt als Dritt-Orakel
- Demografie- und Human-Capital-Diagramm
- Krisen-Seismograph für Frühwarnsignale

Die Terminalbreitensicherheit aus V4 gilt für alle neuen Renderer weiter.
